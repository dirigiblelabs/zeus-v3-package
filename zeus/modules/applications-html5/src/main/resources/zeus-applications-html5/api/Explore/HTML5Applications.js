...
var http = require('zeus-applications-html5/api/http');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('HTML5Applications not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/zeus-applications-html5/api/HTML5Applications.js/' + entity.Id);
