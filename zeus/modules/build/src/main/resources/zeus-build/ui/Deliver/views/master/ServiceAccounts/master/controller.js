...
.factory('$messageHub', [function(){
	...
	var message = function(evtName, data){
		messageHub.post({data: data}, 'zeus.Deliver.ServiceAccounts.' + evtName);
	};
	...
	return {
		...
		onEntityRefresh: function(callback) {
			on('zeus.Deliver.ServiceAccounts.refresh', callback);
		},
...
.controller('PageController', function ($scope, $http, $messageHub) {
	...
	var api = '../../../../../../../../../../services/v3/js/zeus-build/api/Deliver/ServiceAccounts.js';
