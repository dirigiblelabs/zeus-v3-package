...
var dao = require('zeus-build/data/dao/Deliver/Secrets');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Secrets not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/zeus-build/api/Secrets.js/' + entity.Id);
