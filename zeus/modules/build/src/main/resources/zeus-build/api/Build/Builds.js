...
var dao = require('zeus-build/data/dao/Build/Builds');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Builds not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/zeus-build/api/Builds.js/' + entity.Id);
