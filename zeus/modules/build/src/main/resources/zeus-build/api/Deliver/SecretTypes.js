...
var dao = require('zeus-build/data/dao/Deliver/SecretTypes');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('SecretTypes not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/zeus-build/api/SecretTypes.js/' + entity.Id);
