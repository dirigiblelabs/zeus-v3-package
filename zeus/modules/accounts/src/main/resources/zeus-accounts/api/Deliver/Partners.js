...
var dao = require('zeus-accounts/data/dao/Deliver/Partners');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('Partners not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/zeus-accounts/api/Partners.js/' + entity.Id);
