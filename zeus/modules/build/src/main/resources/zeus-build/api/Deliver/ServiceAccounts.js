...
var dao = require('zeus-build/data/dao/Deliver/ServiceAccounts');
var http = require('zeus-build/api/http');
	...
	.resource('{id}')
		.get(function(ctx) {
			...
			if (entity) {
				...
				http.sendResponseNotFound('ServiceAccounts not found');
			}
		})
	.resource('')
		.post(function(ctx, request, response) {
			...
			response.setHeader('Content-Location', '/services/v3/js/zeus-build/api/ServiceAccounts.js/' + entity.Id);
